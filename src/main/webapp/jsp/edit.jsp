...
<%@ page import="edpanichkin.resumes.util.DateUtil" %>
<%@ page import="edpanichkin.resumes.model.*" %>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="edpanichkin.resumes.model.Organization.Position"/>
                                <dl>
